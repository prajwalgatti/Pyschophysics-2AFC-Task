...
function generateBlockInfo(SubjectID, change_angle){
	...
	var block_cue = function(s_id){
		let cue = [6,3,3,6,6,3,6,3];
		if(s_id%2==0){
			return cue;
		}
		else if(s_id%2==1){
	...
	block_info[2] = getTaskDesign(block = 3, block_cue, hemi_rewardcue, ch_angles);
	block_info[3] = getTaskDesign(block = 4, block_cue, hemi_rewardcue, ch_angles);
	block_info[4] = getTaskDesign(block = 5, block_cue, hemi_rewardcue, ch_angles);
	block_info[5] = getTaskDesign(block = 6, block_cue, hemi_rewardcue, ch_angles);
	block_info[6] = getTaskDesign(block = 7, block_cue, hemi_rewardcue, ch_angles);
	block_info[7] = getTaskDesign(block = 8, block_cue, hemi_rewardcue, ch_angles);
